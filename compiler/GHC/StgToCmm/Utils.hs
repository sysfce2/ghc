...
--
-- This function is meant to be folded over a @[CmmInfoTable]@. The initial
-- stats given to the function will (or should) only contain stats for stack
-- info tables skipped during 'generateCgIPEStub'. As the fold progresses,
-- counts of tables per closure type will be accumulated.
